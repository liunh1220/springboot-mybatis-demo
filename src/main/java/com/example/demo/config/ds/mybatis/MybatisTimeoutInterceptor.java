package com.example.demo.config.ds.mybatis;

/**
 * Created by Administrator on 2018/5/20.
 */

import com.example.demo.config.ds.DataSourceHolder;
import com.example.demo.config.ds.DataSourceTimeoutResolver;
...
public class MybatisTimeoutInterceptor implements Interceptor {
    ...
    public MybatisTimeoutInterceptor(ApplicationContext applicationContext){
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        try {
            ...
            if (statement != null && statement.getQueryTimeout() <= 0) {
                ...
                DataSourceTimeoutResolver dataSourceTimeoutResolver = new DataSourceTimeoutResolver(applicationContext);
